               ...
               <tbody className="font-mono">
                 {loading ? (
                   ...
                   <tr key={i} className="border-b border-panel-border/20 hover:bg-black/5 dark:hover:bg-black/5 dark:hover:bg-white/5 transition-colors group">
                     ...
                     <td className="py-4 px-4 text-right text-emerald-600 dark:text-emerald-400 font-bold bg-emerald-500/5 dark:drop-shadow-[0_0_2px_#10B981]">
            ...
            <form onSubmit={handleCreateInsumo} className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    >
                       <optgroup label="🌿 Nutrición" className="font-bold text-emerald-600 dark:text-emerald-400 bg-white dark:bg-[#1b2028]">
                           <option value="fertilizante" className="font-normal text-brand-slate-600 dark:text-slate-300">Fertilizante (NPK / Líquido)</option>
                           <option value="estimulador" className="font-normal text-brand-slate-600 dark:text-slate-300">Estimulador / Hormona / Booster</option>
                           <option value="correctivo_ph" className="font-normal text-brand-slate-600 dark:text-slate-300">Corrector de pH (Up / Down)</option>
                       </optgroup>
                       <optgroup label="🌱 Sustrato & Medio" className="font-bold text-amber-600 dark:text-amber-500 bg-white dark:bg-[#1b2028]">
                           <option value="sustrato" className="font-normal text-brand-slate-600 dark:text-slate-300">Sustrato (Tierra / Coco / Perlita)</option>
                           <option value="maceta" className="font-normal text-brand-slate-600 dark:text-slate-300">Macetas / Contenedores</option>
                       </optgroup>
                       <optgroup label="🛡️ Protección" className="font-bold text-rose-600 dark:text-rose-500 bg-white dark:bg-[#1b2028]">
                           <option value="pesticida_biologico" className="font-normal text-brand-slate-600 dark:text-slate-300">Pesticida Biológico (Neem, BT...)</option>
                           <option value="fungicida" className="font-normal text-brand-slate-600 dark:text-slate-300">Fungicida / Anti-moho</option>
                           <option value="acaricida" className="font-normal text-brand-slate-600 dark:text-slate-300">Acaricida (Anti-ácaros)</option>
                       </optgroup>
                       <optgroup label="💡 Equipamiento" className="font-bold text-blue-600 dark:text-blue-400 bg-white dark:bg-[#1b2028]">
                           <option value="semilla" className="font-normal text-brand-slate-600 dark:text-slate-300">Semillas / Esquejes / Clones</option>
                           <option value="embalaje" className="font-normal text-brand-slate-600 dark:text-slate-300">Embalaje / Packaging</option>
                           <option value="equipamiento" className="font-normal text-brand-slate-600 dark:text-slate-300">Equipamiento / Accesorio</option>
                       </optgroup>
                       <optgroup label="🍃 Cosecha" className="font-bold text-teal-600 dark:text-teal-400 bg-white dark:bg-[#1b2028]">
                           <option value="cosecha_b2b" className="font-normal text-brand-slate-600 dark:text-slate-300">Compra Cosecha Seca (B2B / Terceros)</option>
                           <option value="cosecha_local" className="font-normal text-brand-slate-600 dark:text-slate-300">Cosecha Propia (Producción Interna)</option>
                       </optgroup>
                       <optgroup label="⚙️ Otros" className="font-bold text-slate-500 bg-white dark:bg-[#1b2028]">
                           <option value="miscelaneo" className="font-normal text-brand-slate-600 dark:text-slate-300">Otros (Misceláneo)</option>
                       </optgroup>
                    </select>
                  </div>
                  <div>
