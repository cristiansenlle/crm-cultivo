...
// 📌 THE CRITICAL FIX: The key for connections in Langchain tools is the "ai_tool" output, not "main".
...
console.log("Successfully fixed visual connection ports to use 'ai_tool' instead of 'main'.");
