...
ssh.connect({ host: '109.199.99.126', username: 'root', password: 'FVRu0i2XiWUP93OtQfI7LvPKod' }).then(async () => {
    console.log('Fetching V8 workflow from VPS SQLite...');
    ...
    try {
        ...
        // Force patches here just in case SQLite got overwritten
        ...
        const fileOut = "n8n-crm-cannabis-FINAL-V8.json";
