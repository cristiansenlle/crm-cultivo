...
async function verify() {
    try {
        ...
        const checkCmd = `node -e "const axios = require('axios'); const k = 'HIDDEN_SECRET_BY_AI'; axios.get('https://opnjrzixsrizdnphbjnq.supabase.co/rest/v1/daily_telemetry?order=created_at.desc&limit=1', { headers: { apikey: k, Authorization: 'Bearer ' + k } }).then(r => console.log(JSON.stringify(r.data[0], null, 2)))"`;
