...
const SUPABASE_KEY = 'sbp_26b273690ba8b9aebca57a19a9fb6dc3e9cc9089';
...
// 🔥 THE CRITICAL FIX: The key for connections in n8n is the Node NAME, not the ID.
...
wf.connections["consultar_protocolos"] = { "main": [[], []] };
wf.connections["crear_protocolo"] = { "main": [[], []] };

aiAgents.forEach(agent => {
    // Add connection for GET
    wf.connections["consultar_protocolos"]["main"][0].push({ "node": agent.name, "type": "ai_tool", "index": 0 });
    // Add connection for POST
    wf.connections["crear_protocolo"]["main"][0].push({ "node": agent.name, "type": "ai_tool", "index": 0 });
...
console.log("Successfully rebuilt workflow mapping tool names directly into the connection graph.");
