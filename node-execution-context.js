...
class NodeExecutionContext {
    ...
    getParentNodes(nodeName, options) {
        const output = [];
        const nodeNames = this.workflow.getParentNodes(nodeName, options?.connectionType, options?.depth);
        for (const n of nodeNames) {
            const node = this.workflow.nodes[n];
            if (!node) {
                console.error("\\n\\n🔥🔥🔥 CRITICAL INTERCEPT: Node name [" + n + "] from getParentNodes does NOT exist in workflow! Skipping! 🔥🔥🔥\\n\\n");
                continue;
            }
            const entry = {
                name: node.name,
    ...
    get nodeFeatures() {
        ...
        return n8n_workflow_1.NodeHelpers.getNodeFeatures(description.features, this.node.typeVersion);
    }
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [])
], NodeExecutionContext.prototype, "workflowSettings", null);
__decorate([
    decorators_1.Memoized,
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [])
...
__decorate([
    ...
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [])
], NodeExecutionContext.prototype, "nodeFeatures", null);
__decorate([
    decorators_1.Memoized,
    __metadata("design:type", Object),
    __metadata("design:paramtypes", [])
