    ...
    <header className="flex items-center justify-between px-4 lg:px-8 py-5 bg-gradient-to-b from-black/5 dark:from-black/40 to-transparent backdrop-blur-sm border-b border-panel-border z-10 sticky top-0">
      ...
      <div className="flex items-center gap-2 lg:gap-4 ml-auto">
        ...
        <button 
          ...
          className="flex items-center gap-2 px-3 py-2 rounded-xl border border-status-red/30 bg-status-red/10 text-status-red hover:bg-status-red/20 transition-colors font-semibold text-sm">
          <SignOut size={18} />
