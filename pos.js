...
async function processSale() {
    ...
    if (!clientNameInput) return alert('Error: Es obligatorio ingresar el nombre completo del comprador para facturar.');
...
async function loadSalesHistory() {
    ...
    try {
        ...
        window.salesHistoryCache = data;
        if (typeof renderPOSAnalytics === 'function') setTimeout(renderPOSAnalytics, 100);
