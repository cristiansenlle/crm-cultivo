  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">Dispositivos IoT</h1>
          <p className="text-gray-400">Gestión y configuración de hardware local y remoto.</p>
        </div>
        <button className="bg-emerald-600 hover:bg-emerald-500 text-white px-4 py-2 rounded font-medium transition-colors">
          + Agregar Dispositivo
        </button>
      </div>
