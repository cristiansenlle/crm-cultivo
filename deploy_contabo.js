...
async function run() {
    ...
    try {
        ...
        const n8nEnv = 'export N8N_HOST=' + host + ' && export WEBHOOK_URL=http://' + host + ':5678/ && export N8N_BASIC_AUTH_ACTIVE=true && export N8N_BASIC_AUTH_USER=admin && export N8N_BASIC_AUTH_PASSWORD=AdminSeguro123! && export EXECUTIONS_DATA_PRUNE=true && export EXECUTIONS_DATA_MAX_AGE=48 && export EXECUTIONS_DATA_PRUNE_MAX_COUNT=500 && export DB_SQLITE_VACUUM_ON_STARTUP=true && export N8N_SECURE_COOKIE=false';
