...
function populateLocationSelects() {
    ...
    const sensorLocSelect = document.getElementById('sensorLocation');
    ...
    if (loadedRooms.length > 0) {
        ...
        if (locSelect) locSelect.innerHTML = optionsHtml;
        if (sensorLocSelect) sensorLocSelect.innerHTML = optionsHtml;
    }
}
